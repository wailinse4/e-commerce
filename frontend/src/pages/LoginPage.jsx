      ...
      <div className="h-full flex items-center justify-center bg-gray-50 px-4 py-8">
        ...
        >
          ...
          >
            ...
            <button
              type="submit"
              className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-all duration-150 ease-in-out hover:scale-[1.02]"
            >
